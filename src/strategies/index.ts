...
import * as thresholdNetworkStakingFromSubgraph from './threshold-network-staking-from-subgraph';
...
const strategies = {
  ...
  'threshold-network-staking-from-subgraph': thresholdNetworkStakingFromSubgraph
};
